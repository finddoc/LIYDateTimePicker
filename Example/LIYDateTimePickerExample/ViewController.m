...
- (void)viewDidLoad {
  ...
  [self.tableView registerClass:[UITableViewCell class]
         forCellReuseIdentifier:kLIYCalendarCellIdentifier];
}
...
- (IBAction)onPickTimeTap:(id)sender {
  LIYDateTimePickerViewController *vc =
      [LIYDateTimePickerViewController timePickerForDate:[NSDate date]
                                                delegate:self];
...
- (void)dateTimePicker:
            (LIYDateTimePickerViewController *)dateTimePickerViewController
